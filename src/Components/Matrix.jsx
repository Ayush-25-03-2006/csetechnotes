...
function Matrix() {
    ...
    useEffect(() => {
      document.title = "Matrix Mathematics"
    })
    return(
        <div className="container mt-4">
      <h2 style={{color:"black", backgroundColor:"white",borderRadius:"25px",fontFamily:"sans-serif", fontSize:"40px"}}>Matrix Mathematics</h2>
      <hr />
